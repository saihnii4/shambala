...
const OurGoalsPart = () => {
  ...
  return (
    <div className={`flex justify-start items-center max-w-shambWidth py-48 mx-auto z-20 relative ${PADDINGX}`}>
      ...
      <div className="hidden md:block absolute w-[90%] left-[55%]">
      ...
      >
        <div className="grid md:gap-[157px] gap-[42px]">
          ...
          <motion.div variants={item}>
            <div className="grid md:gap-20 gap-[60px] md:w-[100%] w-[97%]">
              ...
              <GoalCard
                desc="Land degradation will be prevented within the framework of the Sustainable Development Goals."
                index="02"
              />
              <GoalCard
                desc="Rehabilitate by establishing green zones in accordance with the specifics of desertified areas."
                index="03"
              />
        ...
        <div className="hidden md:block absolute w-[85%] left-[70%] top-[17%]">
